    ...
    <div class="col-lg-8">
      ...
      <div class="box box-warning">
        ...
        <div class="box-body">';
				...
				if ($tcc != 0)
					{
					//echo '<div id="pieCanvas" style="position:absolute; height:350px; width:380px; z-index:1; left: 0px; top: 0px;"></div>';
					
					
					echo '<div id="pieCanvas" style="height:350px; width:100%; z-index:1; left: 0px; top: 0px;"></div>';
