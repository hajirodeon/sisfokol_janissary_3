	        ...
	        <div class="box-body">';
				...
				if ($count != 0)
					...
					do
						...
						$qku = mysqli_query($koneksi, "SELECT * FROM user_blog_status ".
														"WHERE kd_user = '$kd' ".
														"ORDER BY postdate DESC LIMIT 0,1");
						$rku = mysqli_fetch_assoc($qku);
						$ku_onlinenya = balikin($rku['onlineya']);
						$ku_ipnya = balikin($rku['ipnya']);
						...
						if ($ku_onlinenya == "YA")
							{
							$ku_onlinenyax = "<font color='green'>$ku_postdate. IP.$ku_ipnya</font>";
							}
						else
							{
