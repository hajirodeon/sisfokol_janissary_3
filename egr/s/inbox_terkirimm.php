		...
		<hr>';
			...
			if ($count != 0)
				...
				do
					...
					$nomer = $nomer + 1;
					$dt_usertipe = balikin($data['uuser_tipe']);
					$dt_userkode = balikin($data['uuser_kode']);
					$dt_usernama = balikin($data['uuser_nama']);
					...
					Kepada : 
					<br>
					<b>['.$dt_usertipe.']. '.$dt_userkode.'. '.$dt_usernama.'</b>
					</p>
				...
				{
				echo '<p>
				<font color="red">Belum Ada INBOX PESAN TERKIRIM</font>.
				</p>';
				}
